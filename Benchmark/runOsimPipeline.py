...
for subjectName in subjects:
    ...
    markerDir = os.path.join(dataDir, subjectName, 'MarkerData')
    forceDir = os.path.join(dataDir, subjectName, 'ForceData')
    mocapDir = os.path.join(markerDir, 'Mocap')
    videoDir = os.path.join(markerDir, 'Video')
    if fixed_markers:
        osDir = os.path.join(dataDir, subjectName, 'OpenSimData_fixed')
    else:
        osDir = os.path.join(dataDir, subjectName, 'OpenSimData')
    
    sessionMetadata = importMetadata(os.path.join(dataDir, subjectName,
